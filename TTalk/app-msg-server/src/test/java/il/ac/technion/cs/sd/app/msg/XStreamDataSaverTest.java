...
public class XStreamDataSaverTest {
	
	XStreamDataSaver<String> fds_str;
	XStreamDataSaver<List<Integer>> fds_list;

	@Before
	public void setUp() throws Exception {
		fds_str = new XStreamDataSaver<String>("StringFileDataSaverTestFile");
		fds_list = new XStreamDataSaver<List<Integer>>("ListFileDataSaverTestFile");
	}
